    ...
    questions: [
      {
        ...
        answer: "Можно нам позвонить/написать в мессенджерах по номеру 8(988)8357227, либо забронировать онлайн на сайте нажав соответствующую кнопку, либо в чате с менеджером тоже по нажатию кнопки (Чат с менеджером).",
        actions: [
