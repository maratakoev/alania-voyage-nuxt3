...
const modalData = ref([
  {
    ...
    serviceType: 'general',
    content: `
      <p><strong>Когда путь приводит в Осетию — приключение становится отдыхом.</strong><br>
      Горы встречают тишиной, воздух пахнет свежим хлебом, а люди — добротой. Здесь чувствуешь, как время замедляется и появляется место для себя.</p>

      <p style="margin-top: 1em;"><strong>Ваш формат отдыха:</strong><br>
      ✓ <u>Тур все включенно</u> — уютное прожиание в горах, питание и экскурсии по сердцу Осетии.<br>
      ✓ <u>Услуги на выбор</u> — жильё, экскурсии и т. д.  — выбираете только нужное.</p>

      <p><strong>Дополнительные развлечения для души и вдохновения:</strong><br>
      Полёт над ущельем, конная прогулка, сплав по горной реке или вечер у костра с видом на закат — Осетия дарит мгновения, к которым хочется возвращаться.</p>

      <p><em>Осетия — не просто место. Это чувство, после которого говоришь: “Я хочу сюда снова”.</em></p>
    `,
...

  {
    ...
    serviceType: 'combo', 
    content: `
  <p style="text-align: center; margin-bottom: 1.5em;"><strong>Осетинские выходные</strong><br><span style="font-size: 1.2em;">«Суббота и воскресенье в горах»</span></p>
...
`,
  ...
  <p style="text-align: center; margin-bottom: 1.2em;">
    <strong style="font-size: 1.1em;">ЭКСКУРСИЯ - БЕСТСЕЛЛЕР</strong><br>
