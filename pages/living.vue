...
const modalData = ref([
{
  ...
  "content": `
    ...
    <p>Варианты размещения по вашему запросу:
    <br><strong>Уединение:</strong> Домики в 5 км от цивилизации, только вы и горные хребты
    <br><strong>Фиагдон:</strong> Современные коттеджи с кафе и экскурсиями у порога
    <br><strong>Экстрим:</strong> Дома на скальных выступах с террасами над пропастью
    <br><strong>Семьи:</strong> Комплексы с огороженной территорией и игровыми площадками</p>

    <p>Все локации лично проверены нами и имеют рейтинг 4.9+ по отзывам гостей. 
    Готовы показать вам Осетию, о которой не пишут в путеводителях — от рассветов над ледниками до секретных троп к водопадам.</p>
...
},
{
  ...
  "content": `  
    ...
    <p>Расположены в пешей доступности от проспекта Мира. 5 минут до театров, 10 минут до набережной Терека. Ваш день начинается с ароматного кофе в старинной кофейне и заканчивается прогулкой под подсветкой мостов XIX века.</p>  

    <p>Выбирайте свой формат:  
    <br>🏛 Апартаменты в здании-памятнике с витражами и лепниной  
    <br>🛋 Стильные лофты с панорамой на Осетинскую церковь  
    <br>🎭 Гостевые дома с билетами на премьеры местных театров</p>  

    <p>Гарантируем:  
    <br>✅ Все объекты проверены лично (чистота, безопасность, аутентичность)  
    <br>✅ 95% вариантов — в радиусе 1 км от Музея истории Осетии  
    <br>✅ Ключи от «закрытых» двориков со столетними яблонями</p>  
